...
class _DropdownRoute<T> extends PopupRoute<_DropdownRouteResult<T>> {
  ...
  _MenuLimits getMenuLimits(Rect buttonRect, double availableHeight, int index) {
    ...
    double preferredMenuHeight =
        dropdownPadding != null ? dropdownPadding!.vertical : kMaterialListPadding.vertical;
    if (items.isNotEmpty) {
  ...
  Widget build(BuildContext context) {
    ...
    Widget result = DefaultTextStyle(
      ...
      child: widget.customButton != null
          ? widget.customButton!(_handleTap)
          : Container(
...
class DropdownButtonFormField2<T> extends FormField<T> {
  ...
  DropdownButtonFormField2({
    ...
    Offset? offset,
    Widget Function(VoidCallback)? customButton,
